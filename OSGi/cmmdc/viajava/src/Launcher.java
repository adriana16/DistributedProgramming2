...
public class Launcher{    
  public static void main(String args[]) throws BundleException { 
    ...
    bundles.add(context.installBundle("file:lib/org.apache.felix.gogo.command-0.16.0.jar"));  
    bundles.add(context.installBundle("file:lib/org.apache.felix.gogo.runtime-0.16.2.jar"));      
